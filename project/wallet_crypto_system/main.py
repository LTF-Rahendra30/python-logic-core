...
from managers import add_transaction,get_transaction,filter_transactions_by_type,filter_transactions_by_date
...
print(add_transaction("joko",2,"in",0.3,"from bahlil","2026-05-30",users))
print(get_wallets_by_user("joko",users))
print(filter_transactions_by_date())
